...
local function client_resize_tiled(c, lay)
    ...
    elseif lay == layout.suit.tile.bottom
        or lay == lain.layout.uselesstile.bottom then
        cursor = "cross"
                              ...
                              for k, v in ipairs(_mouse.buttons) do
                                  if v then
                                      ...
                                      lay == lain.layout.uselesstile.left then
                                          mwfact = 1 - fact_x
                                          wfact = wfact_y
                                      elseif lay == layout.suit.tile.bottom or
                                      lay == lain.layout.uselesstile.bottom then
                                          mwfact = fact_y
                                          wfact = wfact_x
                                      else
                                          mwfact = 1 - fact_y
...
function mouse.client.resize(c, corner)
    ...
    elseif lay == layout.suit.tile
        ...
        or lay == lain.layout.uselesstile.bottom
        then
